...
namespace NetORMLibUnitTest.CommandBuilders
{
	...
	public class SqlDeleteCommandBuilderUnitTest
	{
		...
		public void ShouldBuildSeveralEqualsFilter()
		{
			...
			query = new Delete<PersonnTable>().Where(PersonnTable.FirstName.IsEqualTo("John"), PersonnTable.LastName.IsEqualTo("Doe"));
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
		...
		public void ShouldBuildNotEqualsFilter()
		{
			...
			query = new Delete<PersonnTable>().Where(PersonnTable.FirstName.IsNotEqualTo("John"));
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
			Assert.AreEqual("DELETE FROM [Personn] WHERE [Personn].[FirstName]<>@FirstName0", command.CommandText);
			Assert.AreEqual(1, command.Parameters.Count);
		...
		public void ShouldBuildGreaterFilter()
		{
			...
			query = new Delete<PersonnTable>().Where(PersonnTable.FirstName.IsGreaterThan("John"));
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
			Assert.AreEqual("DELETE FROM [Personn] WHERE [Personn].[FirstName]>@FirstName0", command.CommandText);
			Assert.AreEqual(1, command.Parameters.Count);
		...
		public void ShouldBuildLowerFilter()
		{
			...
			query = new Delete<PersonnTable>().Where(PersonnTable.FirstName.IsLowerThan("John"));
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
			Assert.AreEqual("DELETE FROM [Personn] WHERE [Personn].[FirstName]<@FirstName0", command.CommandText);
			Assert.AreEqual(1, command.Parameters.Count);
		...
		public void ShouldBuildGreaterOrEqualFilter()
		{
			...
			query = new Delete<PersonnTable>().Where(PersonnTable.FirstName.IsGreaterOrEqualTo("John"));
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
			Assert.AreEqual("DELETE FROM [Personn] WHERE [Personn].[FirstName]>=@FirstName0", command.CommandText);
			Assert.AreEqual(1, command.Parameters.Count);
		...
		public void ShouldBuildLowerOrEqualFilter()
		{
			...
			query = new Delete<PersonnTable>().Where(PersonnTable.FirstName.IsLowerOrEqualTo("John"));
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
			Assert.AreEqual("DELETE FROM [Personn] WHERE [Personn].[FirstName]<=@FirstName0", command.CommandText);
			Assert.AreEqual(1, command.Parameters.Count);
		...
		public void ShouldBuildIsNullFilter()
		{
			...
			query = new Delete<PersonnTable>().Where(PersonnTable.FirstName.IsNull());
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
		...
		public void ShouldBuildIsNotNullFilter()
		{
			...
			query = new Delete<PersonnTable>().Where(PersonnTable.FirstName.IsNotNull());
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
		...
		public void ShouldBuildSimpleAndFilterWith2Members()
		{
			...
			query = new Delete<PersonnTable>().Where(new AndFilter<PersonnTable>(PersonnTable.FirstName.IsNotNull(), PersonnTable.LastName.IsEqualTo("Doe") ) );
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
		...
		public void ShouldBuildSimpleAndFilterWith3Members()
		{
			...
			query = new Delete<PersonnTable>().Where(new AndFilter<PersonnTable>(PersonnTable.FirstName.IsNotNull(), PersonnTable.LastName.IsEqualTo("Doe"), PersonnTable.LastName.IsEqualTo("Doe")));
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
		...
		public void ShouldBuildNestedAndFilter()
		{
			...
			query = new Delete<PersonnTable>().Where(new AndFilter<PersonnTable>(PersonnTable.FirstName.IsEqualTo("John"),  new AndFilter<PersonnTable>(PersonnTable.FirstName.IsNotNull(), PersonnTable.LastName.IsEqualTo("Doe") ), PersonnTable.LastName.IsEqualTo("Doe") ));
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
		...
		public void ShouldBuildSimpleOrFilterWith2Members()
		{
			...
			query = new Delete<PersonnTable>().Where(new OrFilter<PersonnTable>(PersonnTable.FirstName.IsNotNull(), PersonnTable.LastName.IsEqualTo("Doe")));
			builder = new SqlCommandBuilder();
			command = builder.BuildCommand(query);
